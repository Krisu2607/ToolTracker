...
public class AddIDToolController {
    ...
    IdTurningDAO idTurningDAO = new IdTurningDAO();
    ...
    private void handleConfirmButton() throws SQLException {
        ...
        List<String> toolIndexes = idTurningDAO.getLastToolIndexByDirection(workDirection);
        ...
        String newIndex = String.format("LT-I-%s-%s", workDirection, newSeqNumStr);

        System.out.println(newIndex);


        TurningID turningID = new TurningID(toolName, newIndex,
                ToolStatus.W_UZYCIU, "",
        ...
        idTurningDAO.addIdTools(turningID);
